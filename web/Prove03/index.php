...
<body onload="showTMs()">
    ...
    <div id="menu" class="grid-container">
        ...
        <div id="cart" onClick="document.forms['hiddenCart'].submit();">
    ...
    <div id="TMCatalog" class="grid-container4">
        <div id="TM1">
            ...
            <input type="text" value="0" name="MD" onkeyup="this.value = MinMax(this.value, 0, 99)" onclick="this.select()">
        ...
        <div id="TM2">
            ...
            <input type="text" value="0" name="FB" onkeyup="this.value = MinMax(this.value, 0, 99)" onclick="this.select()">
        ...
        <div id="TM3">
            ...
            <input type="text" value="0" name="WG" onkeyup="this.value = MinMax(this.value, 0, 99)" onclick="this.select()">
        ...
        <div id="TM4">
            ...
            <input type="text" value="0" name="TB" onkeyup="this.value = MinMax(this.value, 0, 99)" onclick="this.select()">
    ...
    <div id="BallCatalog" class="grid-container4">
        <div id="ball1">
            ...
            <input type="text" value="0" name="PB" onkeyup="this.value = MinMax(this.value, 0, 99)" onclick="this.select()">
        ...
        <div id="ball2">
            ...
            <input type="text" value="0" name="GB" onkeyup="this.value = MinMax(this.value, 0, 99)" onclick="this.select()">
        ...
        <div id="ball3">
            ...
            <input type="text" value="0" name="UB" onkeyup="this.value = MinMax(this.value, 0, 99)" onclick="this.select()">
        ...
        <div id="ball4">
            ...
            <input type="text" value="0" name="MB" onkeyup="this.value = MinMax(this.value, 0, 1)" onclick="this.select()">
            <button onclick="addItem('MB')">Add to cart</button>
            <h4>¥ 20,000</h4>
        </div>
        <form action="cart.php" method="POST" id="hiddenCart">
            <input type="hidden" id="_MD">
            <input type="hidden" id="_FB">
            <input type="hidden" id="_WG">
            <input type="hidden" id="_TB">
            <input type="hidden" id="_PB">
            <input type="hidden" id="_GB">
            <input type="hidden" id="_UB">
            <input type="hidden" id="_MB">
        </form>
    </div>
</body>
</html>